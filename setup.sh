...
gather_settings() {
  ...
  DEFAULT_NAMESPACE="com.pttrn42.microprimer.servicechassispring"
...
setup_description() {
  ...
  "${SED[@]}" -e "s/$DESCRIPTION_PLACEHOLDER/$PROJECT_DESCRIPTION/g" app/src/main/java/com/pttrn42/microprimer/servicechassispring/infrastructure/api/SwaggerConfiguration.java
  "${SED[@]}" -e "s/$DESCRIPTION_PLACEHOLDER/$PROJECT_DESCRIPTION/g" app/src/main/resources/static/index.html
}

setup_project_name() {
  echo "Setting project name"
  PROJECT_NAME_PLACEHOLDER="service-chassis-spring"
  ...
  "${SED[@]}" -e "s/$PROJECT_NAME_PLACEHOLDER/$PROJECT_NAME/g" app/src/main/java/com/pttrn42/microprimer/servicechassispring/infrastructure/api/SwaggerConfiguration.java
...
move_sources() {
  ...
  mv $SOURCE_SET/java/com/pttrn42/microprimer/servicechassispring/* $SOURCE_SET/java/${NAMESPACE//\.//}/$PACKAGE_DIRECTORY
  rm -rf $SOURCE_SET/java/com/pttrn42/microprimer/servicechassispring
}
